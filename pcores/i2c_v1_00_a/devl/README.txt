...
Peripheral Summary:
  ...
  XPS project / EDK repository               : C:\hlocal\I2C\EDK
  logical library name                       : i2c_v1_00_a
  top name                                   : i2c
  version                                    : 1.00.a
  type                                       : PLB (v4.6) slave
...
plbv46_slave_single_v1_01_a
	C:\hlocal\I2C\EDK\C:\Xilinx\14.1\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\plbv46_slave_single_v1_01_a\doc\plbv46_slave_single.pdf

rdpfifo_v4_02_a
	C:\hlocal\I2C\EDK\C:\Xilinx\14.1\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\rdpfifo_v4_02_a\doc\rdpfifo.pdf

wrpfifo_v5_01_a
	C:\hlocal\I2C\EDK\C:\Xilinx\14.1\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\wrpfifo_v5_01_a\doc\wrpfifo.pdf
...
IP2RFIFO_WrReq
    An indication that the IP is attempting to write the data on the 
    IP2RFIFO_Data bus to the User IP side of the RdFIFO. The transaction is not 
    completed until the RdFIFO responds with an active high assertion on the 
    RFIFO2IP_WrAck signal and a corresponding rising edge of the Bus2IP_Clk 
    signal occurs. 

IP2RFIFO_Data
    Transmits write data from the User IP to the RdFIFO write port. Data present 
    on the bus is written when IP2RFIFO_WrReq is high, RFIFO2IP_WrAck is high, 
    and a rising edge of the Bus2IP_Clk occurs. 

RFIFO2IP_WrAck
    Indicates that the data write request will complete at the next rising edge 
    of the Bus2IP_Clk signal. 

RFIFO2IP_AlmostFull
    Indicates that the RdFIFO can accept only one more data write. 

RFIFO2IP_Full
    Indicates that the RdFIFO is full and cannot accept data. The RFIFO2IP_WrAck 
    signal assertion is suppressed until the FIFO is no longer full. 
