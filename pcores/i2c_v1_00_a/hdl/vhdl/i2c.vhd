------------------------------------------------------------------------------
-- i2c.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
architecture IMP of i2c is
  ...
  ------------------------------------------
  constant USER_RDFIFO_DEPTH              : integer              := 32;
  ...
  ------------------------------------------
  constant RFF_INCLUDE_VACANCY            : boolean              := false;
  ...
  ------------------------------------------
  constant USER_WRFIFO_DEPTH              : integer              := 32;
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity i2c_v1_00_a.user_logic
    generic map
    (
