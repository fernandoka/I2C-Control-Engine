...
Peripheral Summary:
  ...
  XPS project / EDK repository               : D:\Pr5
  logical library name                       : lcd_manager_v1_00_a
  top name                                   : lcd_manager
  version                                    : 1.00.a
  type                                       : PLB (v4.6) slave
...
- XST synthesis file(s)
  ...
  devl/synthesis/lcd_manager_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/lcd_manager_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/lcd_manager_v2_1_0.tcl
...
plbv46_slave_single_v1_01_a
	D:\Pr5\e:\Xilinx\14.1\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\plbv46_slave_single_v1_01_a\doc\plbv46_slave_single.pdf

wrpfifo_v5_01_a
	D:\Pr5\e:\Xilinx\14.1\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\wrpfifo_v5_01_a\doc\wrpfifo.pdf
...
IP2WFIFO_RdMark
    Commands the WrFIFO to perform a "Mark" operation. 

IP2WFIFO_RdRelease
    Commands the WrFIFO to perform a "Release" operation. 

IP2WFIFO_RdRestore
    Commands the WrFIFO to perform a "Restore" operation. 
