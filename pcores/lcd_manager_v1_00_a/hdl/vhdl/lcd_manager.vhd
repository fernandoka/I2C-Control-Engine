------------------------------------------------------------------------------
-- lcd_manager.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          lcd_manager.vhd
-- Version:           1.00.a
-- Description:       Top level design, instantiates library components and user logic.
-- Date:              Thu Jan 31 11:09:14 2019 (by Create and Import Peripheral Wizard)
...
library lcd_manager_v1_00_a;
use lcd_manager_v1_00_a.user_logic;
...
end entity lcd_manager;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of lcd_manager is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity lcd_manager_v1_00_a.user_logic
    generic map
    (
    ...
    (
	 ...
	 rs			=>rs,  --setup/data for lcd
	 e  			=>e,  --enable for lcd
	 lcd_data	=>lcd_data, --data signals for lcd
