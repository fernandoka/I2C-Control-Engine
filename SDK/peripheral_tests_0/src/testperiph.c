 ...
 *
 * Institute: Facultad de Informatica Universidad Complutense de Madrid
 *
 * Brief: Final project of the signature "Sistemas Empotrados"(Embeded Systems).
 *
 * Date: 2019
 * */
...
#define DataEngine 0x9E000000 //stop(1) dir(0) halfStep=0(2) numpasos=7(4 to 15) speed=0(16)
#define DataEngine2 0x94000000 //stop(1) dir(0) halfStep=0(2) numpasos=2(4 to 15) speed=0(16)
#define StopEngine 0x40000000 //stop(1) dir(0) halfStep=0(2) numpasos=0(4 to 15) speed=0(16)
...
void setSteps(Xuint8 res1, Xuint8 res2){
	Xuint32 dat= res1 >= 0x00 && res1<=0x68 ? DataEngine | secondSpeed : DataEngine;
...
void runEngine(){
	...
	Xuint8 datos[5], datos2[5],cont=REFRESH_TEMP;
